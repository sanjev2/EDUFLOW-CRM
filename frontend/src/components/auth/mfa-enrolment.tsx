...
export function MfaEnrolment() {
  const router = useRouter(); const [setup, setSetup] = useState<Start>(); const [codes, setCodes] = useState<string[]>(); const [confirmed, setConfirmed] = useState(false); const [busy, setBusy] = useState(true); const [error, setError] = useState("");
